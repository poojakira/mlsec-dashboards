...
This repository is maintained as a **authenticated evidence aggregation service**.

## Production purpose

serve portfolio dashboards and aggregate bounded JSON evidence through authenticated APIs.

## Release gate

A release is promotable only when auth/health/metrics tests, file-boundary checks, lint, dependency audit, and container startup pass.
